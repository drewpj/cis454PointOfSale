...
//hellothere
$sql = "SELECT user_firstname, user_lastname FROM dbo.User454 WHERE user_email='$user_email' AND PWDCOMPARE('$user_password', user_password)"; //AND PWDCOMPARE(N'$pwd', user_password) = 1";
